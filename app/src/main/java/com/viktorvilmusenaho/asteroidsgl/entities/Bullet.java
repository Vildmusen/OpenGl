...
public class Bullet extends GLEntity {
    ...
    private static final float PLAYER_SHOT_SPEED = 120f; //TODO: game play settings
    private static final float ENEMY_SHOT_SPEED = 40f; //TODO: game play settings
    public static final float TIME_TO_LIVE = 2.0f; //seconds

    public float _ttl = TIME_TO_LIVE;
    public boolean _playerFriendly = true;
